...
const PhoneNumberScreen = ({ nextStep }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-white">
      <div className="w-full max-w-md p-4">
        ...
        <h1 className="text-2xl font-semibold mb-4">What's your personal phone number or email address?</h1>
        <input
          type="text"
          placeholder="+923360319894"
          value={phone}
